...
func SeedUsers(ctx context.Context, db *pgxpool.Pool) error {
	query := `
		INSERT INTO public.users (id,email,"password","role",is_verified,created_at,updated_at) VALUES
			...
			('d66619fb-d37a-47d4-b2e3-841691fbd1a1'::uuid,'rifef84546@neuraxo.com','$argon2id$v=19$m=65536,t=3,p=2$VTNHlDL3mdn/Ll6mYRnKrQ$n7Ic1cr7LKZeYEnBRLrN08iuLvoOaUnQ9CuH5T6KOpw','user',true,'2025-05-19 03:49:52.892776+07',NULL)
