...
func SeedProfiles(ctx context.Context, db *pgxpool.Pool) error {
	query := `
		INSERT INTO public.profiles (user_id,fullname,phone,address,image,created_at,updated_at) VALUES
			...
			('d66619fb-d37a-47d4-b2e3-841691fbd1a1'::uuid,'','','','','2025-05-19 03:49:14.898142+07',NULL),	 
			('8a60a062-c0a8-4034-b2f1-a832b9adb435'::uuid,'Imanul Amin Test Edit','081211112222','JL. Kutilang No. 123','','2025-05-18 20:42:23.05615+07',NULL)
